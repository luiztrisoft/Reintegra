...
/**
 * Esta classe é responsável por a presentar a view com a tabela de ajuda de
 * custo do interno a ser selecionada para alteração de dados.
 * 
 * @author Luiz Alberto
 * 
 */
@SuppressWarnings("serial")
public class SelecaoContaAlteracao extends JDialog {
	...
	public SelecaoContaAlteracao(JFrame jf, String s, boolean b, int idInterno) {
		super(jf, s, b);
		c = getContentPane();
		setLayout(null);
		setSize(470, 280);
