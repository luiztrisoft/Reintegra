 ...
 * cadastro, navegação, alteração, recuperação e remoção.
 * 
 * @author Luiz Alberto
 * 
 */
public class TelaCadastroFuncionario extends JDialog {
	...
	private void botoes() {
		...
		String[] texto = { " Gravar dados do funcionário" };
	...
	private void formulario() {
		...
		// radio button de status(remunerado, voluntário, cedido)
		...
		// textField com os dados do funcionário
		...
		// botões camera, foto e adicionar cargo
		for (int i = 0; i < QUANTIDADE_BOTOES; i++) {
