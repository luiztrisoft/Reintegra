...
/**
 * Esta classe é reponsável por construir a view de entrada de receitas no livro
 * caixa.
 * 
 * @author Luiz Alberto
 * 
...
public class TelaEntradaLivroCaixa extends JDialog {
	 ...
	 * @param b
	 */
	public TelaEntradaLivroCaixa(JFrame jf, String s, boolean b) {
		super(jf, s, b);
		c = getContentPane();
		setLayout(null);
		setSize(670, 300);
	...
	private void formulario() {
		...
		// ::::::::JLabel::::::::
		label = new JLabel[5];
		String txtLabel[] = { "Entrada no Livro Caixa", "Data", "Categoria",
				"Observações", "Valor" };
		...
		// ::::::::JButton::::::::
		String txtButton[] = { "Adicionar categoria", "Registrar entrada",
				"Cancelar" };
	...
	private void inputEntrada() {
		boolean b = Show
				.caixaConfirmacao("<html><h2>Deseja registrar a entrada no livro caixa?");
		if (b == true) {
			CadastraRegistroLivroMetodos funcao = new CadastraRegistroLivroMetodos();
			funcao.entradaLivroCaixa(campo, combo);
			resetFields();
		}
	}
