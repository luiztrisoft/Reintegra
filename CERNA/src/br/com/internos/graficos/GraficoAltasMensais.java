...
/**
 * Esta classe mostra o gráfico com os meses de altas dos internos. Obs.: O
 * gráfico apresenta somente os internos passivos.
 * 
 * @author Luiz Alberto
 * 
 */
...
public class GraficoAltasMensais extends GraficoControl {
	...
	private static JPanel createDemoPanel() {
		JFreeChart chart = createChart(
				"Gráfico por mês de alta de internos passivos",
