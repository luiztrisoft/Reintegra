...
/**
 * Esta classe cria a tela de que será utilizada para o cadastro dos internos.
 * 
 * @author Luiz Alberto
 * 
 */
...
public class TelaCadastroInterno extends JDialog {
	...
	/**
	 * Este método executa as funções webcam, abrir arquivo e adicionar convênio
	 * do formulário.
	 */
